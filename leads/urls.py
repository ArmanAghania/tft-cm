...
from .views import (
    LeadListView, LeadDetailView, LeadCreateView, LeadUpdateView, LeadDeleteView, FullLeadListView,
    ...
    BankListView, BankCreateView, BankUpdateView, BankDeleteView, CreateLeadFromBankNumberView,
    ...
    MessageListView, BulkMessageDeleteView,
    download_excel_page,
...
urlpatterns = [
    ...
    path('import_leads_agents/', LeadImportAgentsView.as_view(),
    ...
    path('create_lead_from_banknumber/<int:pk>/',
         CreateLeadFromBankNumberView.as_view(), name='create_lead_from_banknumber'),
    path('distribution_wizard/',
         LeadDistributionWizard.as_view(FORMS), name='dist_view'),
    ...
    path('<int:pk>/sales/create/', SaleCreateView.as_view(),
         name='lead-sales-create'),
    path('sales/update/<int:pk>/', LeadSalesEditView.as_view(),
         name='lead-sales-update'),
    path('sales/<int:pk>/delete/', SaleDeleteView.as_view(),
         name='lead-sales-delete'),
    path('sales/daily_sales_chart/', generic.TemplateView.as_view(
        template_name='leads/daily_chart.html'), name='daily_sales_chart'),
    path('sales/daily_sales_chart/data/',
         DailySalesChart.as_view(), name='daily_sales_chart_data'),
    path('monthly-report/daily_sales_chart/data/',
         DailySalesChart.as_view(), name='daily_sales_chart_data'),
    path('sales/weekly_sales_chart/', generic.TemplateView.as_view(
        template_name='leads/weekly_chart.html'), name='weekly_sales_chart'),
    path('sales/weekly_sales_chart/data/',
         WeeklySalesChart.as_view(), name='weekly_sales_chart_data'),
    path('monthly-report/weekly_sales_chart/data/',
         WeeklySalesChart.as_view(), name='weekly_sales_chart_data'),
    path('sales/monthly_sales_chart/', generic.TemplateView.as_view(
        template_name='leads/monthly_chart.html'), name='monthly_sales_chart'),
    path('sales/monthly_sales_chart/data/',
         MonthlySalesChart.as_view(), name='monthly_sales_chart_data'),
    path('monthly-report/monthly_sales_chart/data/',
         MonthlySalesChart.as_view(), name='monthly_sales_chart_data'),
    path('sales/yearly_sales_chart/', generic.TemplateView.as_view(
        template_name='leads/yearly_chart.html'), name='yearly_sales_chart'),
    path('sales/yearly_sales_chart/data/',
         YearlySalesChart.as_view(), name='yearly_sales_chart_data'),
    path('monthly-report/yearly_sales_chart/data/',
         YearlySalesChart.as_view(), name='yearly_sales_chart_data'),
    path('sources/', SourceListView.as_view(), name='source-list'),
    path('sources/<int:pk>/', SourceDetailView.as_view(), name='source-detail'),
    path('sources/<int:pk>/update/',
         SourceUpdateView.as_view(), name='source-update'),
    ...
    path('team/<int:team_id>/member/<int:agent_id>/leads/',
         TeamMemberLeadView.as_view(), name='team-member-leads'),
    path('create-team/', TeamCreateView.as_view(), name='team-create'),
    path('download-excel/', download_excel_page, name='download_excel_page'),
    path('run_background_tasks/', run_background_tasks,
         name='run_background_tasks'),
    path('stop_background_tasks/', stop_background_tasks,
