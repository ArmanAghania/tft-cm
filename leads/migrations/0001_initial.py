    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.IntegerField(choices=[(1, '1'), (2, '2'), (3, '3'), (4, 'آموزش')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='leads.lead')),
            ],
        ),
        migrations.AddField(
            model_name='lead',
